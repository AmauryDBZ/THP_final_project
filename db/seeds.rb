...
bank_name_array = ['Banque de France‎','BNP Paribas‎','Crédit Agricole‎','Banque Populaire',"Caisse d'Epargne",'Crédit Lyonnais (LCL)','HSBC','Crédit Mutuel','La Banque Postale','Dexia Banque']
iban_array = ['FR7630001007941234567890185','FR7630004000031234567890143','FR7630006000011234567890189','FR7610107001011234567890129','FR7611315000011234567890138','FR7630002032531234567890168','FR7630056009271234567890182','FR7611808009101234567890147','FR761001100020123456789018','FR7630076020821234567890186']
branch_code_array = ['00003','00001','00101','00001','03253','00927','00910','00020','02082','00001']
...
10.times do
  ...
  bank_detail = BankDetail.create(
    ...
    iban: iban_array[i],
    branch_code: branch_code_array[i],
    bank_code: bank_code_array [i],
    account_number: account_number_array[i],
    key: key_array[i]
  )
